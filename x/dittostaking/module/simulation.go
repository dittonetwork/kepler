...
import (
	...
	"kepler/x/dittostaking/simulation"
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	dittostakingGenesis := types.GenesisState{
		Params: types.DefaultParams(),
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&dittostakingGenesis)
}
