...
// source: kepler/accounts_defaults_lockup/v1/lockup.proto
...
func (*Period) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7e8333a3af60831, []int{0}
}
...
func (*UnbondingEntries) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7e8333a3af60831, []int{1}
}
...
func (*UnbondingEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7e8333a3af60831, []int{2}
}
...
func init() {
	proto.RegisterType((*Period)(nil), "kepler.accounts_defaults_lockup.v1.Period")
	proto.RegisterType((*UnbondingEntries)(nil), "kepler.accounts_defaults_lockup.v1.UnbondingEntries")
	proto.RegisterType((*UnbondingEntry)(nil), "kepler.accounts_defaults_lockup.v1.UnbondingEntry")
}

func init() {
	proto.RegisterFile("kepler/accounts_defaults_lockup/v1/lockup.proto", fileDescriptor_f7e8333a3af60831)
}

var fileDescriptor_f7e8333a3af60831 = []byte{
	// 519 bytes of a gzipped FileDescriptorProto
	,
}
