...
import (
	...
	"kepler/x/symbioticadapter/simulation"
	"kepler/x/symbioticadapter/types"
)
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	symbioticadapterGenesis := types.GenesisState{
		Params: types.DefaultParams(),
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&symbioticadapterGenesis)
}
