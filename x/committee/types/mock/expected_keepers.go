...
// MockExecutors is a mock of Executors interface.
type MockExecutors struct {
	ctrl     *gomock.Controller
	recorder *MockExecutorsMockRecorder
	isgomock struct{}
}

// MockExecutorsMockRecorder is the mock recorder for MockExecutors.
type MockExecutorsMockRecorder struct {
	mock *MockExecutors
}

// NewMockExecutors creates a new mock instance.
func NewMockExecutors(ctrl *gomock.Controller) *MockExecutors {
	mock := &MockExecutors{ctrl: ctrl}
	mock.recorder = &MockExecutorsMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockExecutors) EXPECT() *MockExecutorsMockRecorder {
	return m.recorder
}

// GetEmergencyExecutors mocks base method.
func (m *MockExecutors) GetEmergencyExecutors(ctx context.Context) ([]types0.ExecutorI, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEmergencyExecutors", ctx)
	ret0, _ := ret[0].([]types0.ExecutorI)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEmergencyExecutors indicates an expected call of GetEmergencyExecutors.
func (mr *MockExecutorsMockRecorder) GetEmergencyExecutors(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEmergencyExecutors", reflect.TypeOf((*MockExecutors)(nil).GetEmergencyExecutors), ctx)
}
