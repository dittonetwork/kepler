...
func (m *GenesisState) GetLastEpoch() int64 {
	if m != nil {
		return m.LastEpoch
	}
	return 0
...
var fileDescriptor_7765d4b3ed94bd5f = []byte{
	...
	0xa7, 0x16, 0xe4, 0x27, 0x67, 0x48, 0x30, 0x29, 0x30, 0x6a, 0x30, 0x07, 0x71, 0x82, 0x44, 0x5c,
	...
	0x4e, 0x62, 0x03, 0x07, 0x81, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xc3, 0x36, 0x9a, 0x8b, 0xa0,
	0x01, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastEpoch |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
