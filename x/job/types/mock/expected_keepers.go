...
func (m *MockCommitteeKeeper) CanBeSigned(ctx types.Context, chainID, committeeID string, signatures [][]byte) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CanBeSigned", ctx, chainID, committeeID, signatures)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCommitteeKeeperMockRecorder) CanBeSigned(ctx, chainID, committeeID, signatures any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CanBeSigned", reflect.TypeOf((*MockCommitteeKeeper)(nil).CanBeSigned), ctx, chainID, committeeID, signatures)
}
