...
func (m *MockRestakingKeeper) ApplyAndReturnValidatorSetUpdates(ctx context.Context) ([]types.ValidatorUpdate, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ApplyAndReturnValidatorSetUpdates", ctx)
...
func (mr *MockRestakingKeeperMockRecorder) ApplyAndReturnValidatorSetUpdates(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyAndReturnValidatorSetUpdates", reflect.TypeOf((*MockRestakingKeeper)(nil).ApplyAndReturnValidatorSetUpdates), ctx)
}
...
func (m *MockAccountKeeper) NewAccount(ctx context.Context, acc types0.AccountI) types0.AccountI {
	m.ctrl.T.Helper()
