...
func NewAppModule(accountKeeper types.AccountKeeper,
	restakingKeeper types.RestakingKeeper, deliverTx genesis.TxHandler,
	txEncodingConfig client.TxEncodingConfig,
...
//nolint:gochecknoinits // init function
func init() {
...
func ProvideModule(in ModuleInputs) appmodule.AppModule {
	m := NewAppModule(in.AccountKeeper, in.RestakingKeeper, in.DeliverTx, in.Config)
	return m
}
