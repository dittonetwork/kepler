...
type Automation struct {
	...
	ExecutedTimes  uint64           `protobuf:"varint,5,opt,name=executed_times,json=executedTimes,proto3" json:"executed_times,omitempty"`
	LastExecutedAt uint64           `protobuf:"varint,6,opt,name=last_executed_at,json=lastExecutedAt,proto3" json:"last_executed_at,omitempty"`
...
func (m *Automation) GetExecutedTimes() uint64 {
	if m != nil {
		return m.ExecutedTimes
	}
	return 0
}

func (m *Automation) GetLastExecutedAt() uint64 {
	if m != nil {
...
type Trigger_Repeatable struct {
	Repeatable *CountTrigger `protobuf:"bytes,4,opt,name=repeatable,proto3,oneof" json:"repeatable,omitempty"`
}
...
func (m *Trigger) GetRepeatable() *CountTrigger {
	if x, ok := m.GetTrigger().(*Trigger_Repeatable); ok {
		return x.Repeatable
	}
	return nil
}
...
var fileDescriptor_e70c979264e1abb3 = []byte{
	...
	,
}
...
func (m *Automation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastExecutedAt != 0 {
		i = encodeVarintAutomation(dAtA, i, uint64(m.LastExecutedAt))
		i--
		dAtA[i] = 0x30
	}
	if m.ExecutedTimes != 0 {
		i = encodeVarintAutomation(dAtA, i, uint64(m.ExecutedTimes))
		i--
		dAtA[i] = 0x28
	}
	if m.ExpireAt != 0 {
...
func (m *Trigger_Repeatable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Trigger_Repeatable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Repeatable != nil {
		{
			size, err := m.Repeatable.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Automation) Size() (n int) {
	...
	if m.ExecutedTimes != 0 {
		n += 1 + sovAutomation(uint64(m.ExecutedTimes))
	}
	if m.LastExecutedAt != 0 {
		n += 1 + sovAutomation(uint64(m.LastExecutedAt))
	}
	if m.Status != 0 {
...
func (m *Trigger_Repeatable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Automation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExecutedTimes", wireType)
			}
			m.ExecutedTimes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExecutedTimes |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastExecutedAt", wireType)
			}
			m.LastExecutedAt = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastExecutedAt |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Trigger) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Trigger = &Trigger_Repeatable{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAutomation(dAtA[iNdEx:])
