...
func (mr *MockKeeperMockRecorder) ActivateAutomation(ctx, id interface{}) *gomock.Call {
...
func (mr *MockKeeperMockRecorder) CancelAutomation(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeeperMockRecorder) FindActiveAutomations(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeeperMockRecorder) GetActiveAutomations(goCtx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeeperMockRecorder) GetAutomation(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeeperMockRecorder) GetNextAutomationID(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeeperMockRecorder) InsertAutomation(ctx, automation interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeeperMockRecorder) Params(goCtx, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeeperMockRecorder) SetAutomationStatus(ctx, id, status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKeeperMockRecorder) SetParams(ctx, params interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
