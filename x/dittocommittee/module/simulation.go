...
import (
	...
	"kepler/x/dittocommittee/simulation"
	"kepler/x/dittocommittee/types"
)
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	dittocommitteeGenesis := types.GenesisState{
		Params: types.DefaultParams(),
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&dittocommitteeGenesis)
}
