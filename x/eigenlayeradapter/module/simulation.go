...
import (
	...
	"kepler/x/eigenlayeradapter/simulation"
	"kepler/x/eigenlayeradapter/types"
)
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	eigenlayeradapterGenesis := types.GenesisState{
		Params: types.DefaultParams(),
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&eigenlayeradapterGenesis)
}
