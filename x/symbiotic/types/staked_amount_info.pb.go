...
func (m *StakedAmountInfo) GetLastUpdateTs() uint64 {
	if m != nil {
...
var fileDescriptor_6e623d6ad52515d6 = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x80, 0x28, 0xd5, 0x83, 0x2b, 0x55, 0x9a, 0xc7, 0xc8,
	...
	0x09, 0xac, 0x0c, 0x45, 0x0c, 0xa4, 0x26, 0x27, 0xb1, 0xb8, 0x24, 0xb4, 0x20, 0x25, 0xb1, 0x24,
	0x35, 0xa4, 0x58, 0x82, 0x59, 0x81, 0x51, 0x83, 0x25, 0x08, 0x45, 0x4c, 0x48, 0x82, 0x8b, 0x3d,
	0xb9, 0x28, 0x35, 0xb1, 0x24, 0xbf, 0x48, 0x82, 0x05, 0x6c, 0x04, 0x8c, 0xeb, 0x64, 0x74, 0xe2,
	0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c, 0xc7, 0x70,
	0xe1, 0xb1, 0x1c, 0xc3, 0x8d, 0xc7, 0x72, 0x0c, 0x51, 0x12, 0x50, 0x7f, 0x57, 0x20, 0xf9, 0xbc,
	0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec, 0x5b, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff,
	0x30, 0xe3, 0xbe, 0x4a, 0x1a, 0x01, 0x00, 0x00,
}
...
func (m *StakedAmountInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LastUpdateTs != 0 {
		i = encodeVarintStakedAmountInfo(dAtA, i, uint64(m.LastUpdateTs))
		i--
		dAtA[i] = 0x18
	}
...
func (m *StakedAmountInfo) Size() (n int) {
	...
	if m.LastUpdateTs != 0 {
		n += 1 + sovStakedAmountInfo(uint64(m.LastUpdateTs))
	}
	l = len(m.Creator)
	if l > 0 {
		n += 1 + l + sovStakedAmountInfo(uint64(l))
