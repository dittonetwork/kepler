...
import (
	...
	"kepler/x/dittoslashing/simulation"
	"kepler/x/dittoslashing/types"
)
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	dittoslashingGenesis := types.GenesisState{
		Params: types.DefaultParams(),
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&dittoslashingGenesis)
}
