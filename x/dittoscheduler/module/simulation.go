...
import (
	...
	"kepler/x/dittoscheduler/simulation"
	"kepler/x/dittoscheduler/types"
)
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	dittoschedulerGenesis := types.GenesisState{
		Params: types.DefaultParams(),
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&dittoschedulerGenesis)
}
