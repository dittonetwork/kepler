...
var _ protoreflect.List = (*_Operators_1_list)(nil)

type _Operators_1_list struct {
	list *[]*Operator
}

func (x *_Operators_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Operators_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_Operators_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Operator)
	(*x.list)[i] = concreteValue
}

func (x *_Operators_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Operator)
	*x.list = append(*x.list, concreteValue)
}

func (x *_Operators_1_list) AppendMutable() protoreflect.Value {
	v := new(Operator)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Operators_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_Operators_1_list) NewElement() protoreflect.Value {
	v := new(Operator)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Operators_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_Operators           protoreflect.MessageDescriptor
	fd_Operators_operators protoreflect.FieldDescriptor
)

func init() {
	file_kepler_restaking_update_proto_init()
	md_Operators = File_kepler_restaking_update_proto.Messages().ByName("Operators")
	fd_Operators_operators = md_Operators.Fields().ByName("operators")
}

var _ protoreflect.Message = (*fastReflection_Operators)(nil)

type fastReflection_Operators Operators

func (x *Operators) ProtoReflect() protoreflect.Message {
	return (*fastReflection_Operators)(x)
}

func (x *Operators) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_Operators_messageType fastReflection_Operators_messageType
var _ protoreflect.MessageType = fastReflection_Operators_messageType{}

type fastReflection_Operators_messageType struct{}

func (x fastReflection_Operators_messageType) Zero() protoreflect.Message {
	return (*fastReflection_Operators)(nil)
}
func (x fastReflection_Operators_messageType) New() protoreflect.Message {
	return new(fastReflection_Operators)
}
func (x fastReflection_Operators_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_Operators
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_Operators) Descriptor() protoreflect.MessageDescriptor {
	return md_Operators
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_Operators) Type() protoreflect.MessageType {
	return _fastReflection_Operators_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_Operators) New() protoreflect.Message {
	return new(fastReflection_Operators)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_Operators) Interface() protoreflect.ProtoMessage {
	return (*Operators)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_Operators) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Operators) != 0 {
		value := protoreflect.ValueOfList(&_Operators_1_list{list: &x.Operators})
		if !f(fd_Operators_operators, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_Operators) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "kepler.restaking.Operators.operators":
		return len(x.Operators) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: kepler.restaking.Operators"))
		}
		panic(fmt.Errorf("message kepler.restaking.Operators does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Operators) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "kepler.restaking.Operators.operators":
		x.Operators = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_Operators) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "kepler.restaking.Operators.operators":
		if len(x.Operators) == 0 {
			return protoreflect.ValueOfList(&_Operators_1_list{})
		}
		listValue := &_Operators_1_list{list: &x.Operators}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: kepler.restaking.Operators"))
		}
		panic(fmt.Errorf("message kepler.restaking.Operators does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Operators) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "kepler.restaking.Operators.operators":
		lv := value.List()
		clv := lv.(*_Operators_1_list)
		x.Operators = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: kepler.restaking.Operators"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Operators) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "kepler.restaking.Operators.operators":
		if x.Operators == nil {
			x.Operators = []*Operator{}
		}
		value := &_Operators_1_list{list: &x.Operators}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: kepler.restaking.Operators"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_Operators) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "kepler.restaking.Operators.operators":
		list := []*Operator{}
		return protoreflect.ValueOfList(&_Operators_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: kepler.restaking.Operators"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_Operators) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in kepler.restaking.Operators", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_Operators) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Operators) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_Operators) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_Operators) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*Operators)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: Operators: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: Operators: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *Operator) slowProtoReflect() protoreflect.Message {
	mi := &file_kepler_restaking_update_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (*Operator) Descriptor() ([]byte, []int) {
	return file_kepler_restaking_update_proto_rawDescGZIP(), []int{3}
}
...
var file_kepler_restaking_update_proto_rawDesc = []byte{
	...
	0x67, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
	...
	,
	...
	0x1f, 0x01, 0x42, 0xb9, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x6b, 0x65, 0x70, 0x6c, 0x65,
	0x72, 0x2e, 0x72, 0x65, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x42, 0x0b, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68,
...
var file_kepler_restaking_update_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_kepler_restaking_update_proto_goTypes = []interface{}{
	...
	(*Operators)(nil),             // 2: kepler.restaking.Operators
	(*Operator)(nil),              // 3: kepler.restaking.Operator
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
	(*anypb.Any)(nil),             // 5: google.protobuf.Any
	(BondStatus)(0),               // 6: kepler.restaking.BondStatus
	(Protocol)(0),                 // 7: kepler.restaking.Protocol
}
var file_kepler_restaking_update_proto_depIdxs = []int32{
	4, // 0: kepler.restaking.UpdateInfo.timestamp:type_name -> google.protobuf.Timestamp
	3, // 1: kepler.restaking.ValidatorsUpdate.operators:type_name -> kepler.restaking.Operator
	0, // 2: kepler.restaking.ValidatorsUpdate.info:type_name -> kepler.restaking.UpdateInfo
	3, // 3: kepler.restaking.Operators.operators:type_name -> kepler.restaking.Operator
	5, // 4: kepler.restaking.Operator.consensus_pubkey:type_name -> google.protobuf.Any
	6, // 5: kepler.restaking.Operator.status:type_name -> kepler.restaking.BondStatus
	7, // 6: kepler.restaking.Operator.protocol:type_name -> kepler.restaking.Protocol
...
func file_kepler_restaking_update_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_kepler_restaking_update_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
