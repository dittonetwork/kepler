...
const (
	Query_Params_FullMethodName = "/kepler.job.Query/Params"
	Query_GetJob_FullMethodName = "/kepler.job.Query/GetJob"
)
...
func (c *queryClient) GetJob(ctx context.Context, in *QueryGetJobRequest, opts ...grpc.CallOption) (*QueryGetJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
