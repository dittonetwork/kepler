...
const (
	...
	Msg_SendReport_FullMethodName   = "/kepler.committee.Msg/SendReport"
)
...
func (c *msgClient) SendReport(ctx context.Context, in *MsgSendReport, opts ...grpc.CallOption) (*MsgSendReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SendReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SendReport(context.Context, *MsgSendReport) (*MsgSendReportResponse, error) {
...
func _Msg_SendReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SendReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
