...
const (
	Query_EpochInfos_FullMethodName   = "/kepler.epochs.Query/EpochInfos"
	Query_CurrentEpoch_FullMethodName = "/kepler.epochs.Query/CurrentEpoch"
	Query_Params_FullMethodName       = "/kepler.epochs.Query/Params"
)
