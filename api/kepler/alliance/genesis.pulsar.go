...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_kepler_alliance_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.QuorumParams != nil {
		...
		if !f(fd_GenesisState_quorumParams, value) {
			return
		}
	}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message kepler.alliance.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message kepler.alliance.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in kepler.alliance.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_kepler_alliance_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (x *GenesisState) GetQuorumParams() *QuorumParams {
	if x != nil {
...
var file_kepler_alliance_genesis_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x6b, 0x65, 0x70, 0x6c, 0x65, 0x72, 0x2f, 0x61, 0x6c, 0x6c, 0x69, 0x61, 0x6e, 0x63,
	0x65, 0x2f, 0x67, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x0f, 0x6b, 0x65, 0x70, 0x6c, 0x65, 0x72, 0x2e, 0x61, 0x6c, 0x6c, 0x69, 0x61, 0x6e, 0x63, 0x65,
...
var (
	file_kepler_alliance_genesis_proto_rawDescOnce sync.Once
	file_kepler_alliance_genesis_proto_rawDescData = file_kepler_alliance_genesis_proto_rawDesc
)

func file_kepler_alliance_genesis_proto_rawDescGZIP() []byte {
	file_kepler_alliance_genesis_proto_rawDescOnce.Do(func() {
		file_kepler_alliance_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_kepler_alliance_genesis_proto_rawDescData)
	})
	return file_kepler_alliance_genesis_proto_rawDescData
}
...
func file_kepler_alliance_genesis_proto_init() {
	if File_kepler_alliance_genesis_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_kepler_alliance_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_kepler_alliance_genesis_proto_goTypes,
		DependencyIndexes: file_kepler_alliance_genesis_proto_depIdxs,
		MessageInfos:      file_kepler_alliance_genesis_proto_msgTypes,
	}.Build()
	File_kepler_alliance_genesis_proto = out.File
	file_kepler_alliance_genesis_proto_rawDesc = nil
	file_kepler_alliance_genesis_proto_goTypes = nil
	file_kepler_alliance_genesis_proto_depIdxs = nil
}
